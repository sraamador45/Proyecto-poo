...
class Animal():
    ...
    def __str__(self):
        return "nombre de animal"+" "+self.nombre+" es un "+" "+self.especie+" "+self.raza+" "+self.edad+" "+"anios"+" "+self.sexo+" "+str(self.peso)+" "+"kg"
    
    def getnombre(self):
        return self.nombre+" "+self.especie+" "+self.raza+" "+self.sexo+" "+self.edad+" "+str(self.peso)+" "+"kg"
